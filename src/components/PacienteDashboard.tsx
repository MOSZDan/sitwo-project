        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Link to="/agendar-cita" className="group flex items-center justify-center p-6 bg-white text-slate-700 rounded-lg shadow-md hover:shadow-lg hover:bg-cyan-500 hover:text-white transition-all duration-300">
                <CalendarIcon />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-sm text-slate-500 mt-2 mb-4">
                Elige si quieres recibir correos con recordatorios de tus citas.
              </p>
